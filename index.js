...
const {
  ...
  loginSchema,
  updateUserSchema,
} = require("./app/validators/user-validation");
...
} = require("./app/validators/operator-validation");
...
const {
  packageSchema,
  packageUpdateSchema,
} = require("./app/validators/package-validations");
...
const {
  channelsSchema,
  channelUpdateSchema,
} = require("./app/validators/channel-validation");
...
} = require("./app/validators/customer-validation");
...
app.get(
  "/api/listAllUsers",
  authenticateUser,
  authorizeUser(["admin", "operator", "customer"]),
  usersCltr.listAllUsers
);
app.get(
  "/api/listSingleUser/:id",
  authenticateUser,
  authorizeUser(["admin"]),
  usersCltr.listSingleUser
);
...
app.post(
  ...
  authenticateUser,
  authorizeUser(["admin"]),
  checkSchema(operatorSchema),
  operatorsCltr.create
);
app.get(
  "/api/listAllOperators",
  authenticateUser,
  authorizeUser(["admin", "operator"]),
  operatorsCltr.listAllOperators
);
app.get(
  "/api/listSingleOperator/:operatorId",
  authenticateUser,
  authorizeUser(["admin"]),
  operatorsCltr.listSingleOperator
);
app.get(
  "/api/getOperatorByUserId/:userId",
  authenticateUser,
  authorizeUser(["admin", "operator"]),
  operatorsCltr.getOperatorByUserId
);
app.put(
  "/api/operator/:operatorId",
  authenticateUser,
  authorizeUser(["operator", "admin"]),
  checkSchema(operatorUpdateSchema),
  operatorsCltr.updateOperator
);
app.put(
  "/api/operator/:operatorId/profile",
  authenticateUser,
  authorizeUser(["operator"]),
  upload.single("file"),
  operatorsCltr.profile
);
app.delete(
  "/api/operator/:operatorId",
  authenticateUser,
  authorizeUser(["admin"]),
  operatorsCltr.deleteOperator
);
app.get(
  "/api/operator/profile",
  authenticateUser,
  authorizeUser(["operator"]),
  operatorsCltr.getProfile
);
...
app.put(
  ...
  authorizeUser(["admin"]),
  upload.single("file"),
  checkSchema(packageUpdateSchema),
  packagesCltr.updatePackage
);
app.delete(
  "/api/packages",
  authenticateUser,
  authorizeUser(["admin"]),
  packagesCltr.deletePackage
);
app.get(
  "/api/listAllDeletedPackages",
  authenticateUser,
  authorizeUser(["admin"]),
  packagesCltr.listAllDeletedPackages
);
...
app.post(
  ...
  authorizeUser(["admin"]),
  upload.single("file"),
  checkSchema(channelsSchema),
  channelsCltr.create
);
app.get(
  "/api/listAllchannels",
  checkSchema(channelsSchema),
  channelsCltr.listAllChannels
);
app.get(
  "/api/listOneChannel/:id",
  checkSchema(channelsSchema),
  channelsCltr.listOneChannel
);
app.put(
  "/api/updateChannel/:id",
  authenticateUser,
  authorizeUser(["admin"]),
  checkSchema(channelUpdateSchema),
  channelsCltr.updateChannel
);
app.delete(
  "/api/deleteChannel/:id",
  authenticateUser,
  authorizeUser(["admin"]),
  channelsCltr.deleteChannel
);
...
app.get(
  ...
  authenticateUser,
  authorizeUser(["operator", "customer"]),
  customerCltr.listAllCustomers
);
app.get(
  "/api/:operatorId/customers",
  authenticateUser,
  authorizeUser(["admin", "operator"]),
  customerCltr.getCustomersByOperatorId
);
app.get(
  "/api/:userId/users/customer",
  authenticateUser,
  authorizeUser(["admin", "operator"]),
  customerCltr.getCustomersByUserId
);
app.get(
  "/api/singleCustomer/:id",
  authenticateUser,
  authorizeUser(["operator", "customer", "admin"]),
  customerCltr.singleCustomer
);
app.put(
  "/api/customer/:customerId",
  authenticateUser,
  authorizeUser(["customer", "operator"]),
  checkSchema(customerUpdateSchema),
  customerCltr.updateCustomer
);
app.put(
  ...
  upload.single("file"),
  customerCltr.profile
);
app.delete(
  "/api/customer/:id",
  authenticateUser,
  authorizeUser(["operator"]),
  customerCltr.deleteCustomer
);
app.get(
...
app.get(
  ...
  authenticateUser,
  authorizeUser(["operator"]),
  paymentsCltr.listSubscribers
);
app.get(
  "/api/payment/subscribersLastThreeMonths",
  authenticateUser,
  authorizeUser(["operator"]),
  paymentsCltr.listSubscribersLastThreeMonths
);
app.get(
  "/api/payment/listIncomeLastThreeMonths",
  authenticateUser,
  authorizeUser(["operator"]),
  paymentsCltr.listIncomeLastThreeMonths
);
app.get(
  "/api/payment/listLastTenPayments",
  authenticateUser,
  authorizeUser(["operator"]),
  paymentsCltr.lastTenPayments
);
app.post(
  "/api/payment",
  authenticateUser,
...
app.get(
  "/api/payment/expiredOrders",
  authenticateUser,
  authorizeUser(["customer"]),
  paymentsCltr.expiredOrders
);
app.put(
  "/api/payment/:id",
  authenticateUser,
...
app.put(
  "/api/payment/:id/activate",
  authenticateUser,
  authorizeUser(["operator"]),
  paymentsCltr.activateSubscription
);
app.delete(
  "/api/payment/:id",
  authenticateUser,
